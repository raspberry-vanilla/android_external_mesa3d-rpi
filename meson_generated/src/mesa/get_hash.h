...
static const struct value_desc values[] = {
    ...
    { GL_STENCIL_REF, LOC_CUSTOM, TYPE_UINT, NO_OFFSET, extra_new_buffers },
    ...
    { GL_MAX_LABEL_LENGTH, CAPS_UINT(max_label_length), NO_EXTRA },
    ...
    { GL_STENCIL_BACK_REF, LOC_CUSTOM, TYPE_UINT, NO_OFFSET, extra_new_buffers },
    ...
    { GL_MAX_VIEWS_OVR, CONST(MAX_VIEWS_OVR), extra_OVR_multiview },
    { GL_MAX_TIMELINE_SEMAPHORE_VALUE_DIFFERENCE_NV, CONTEXT_INT64(Const.MaxTimelineSemaphoreValueDifference), extra_NV_timeline_semaphore },
    ...
    { GL_MAX_SHADER_PIXEL_LOCAL_STORAGE_SIZE_EXT, CAPS_UINT(shader_pixel_local_storage_size), extra_EXT_shader_pixel_local_storage },
    { GL_MAX_SHADER_PIXEL_LOCAL_STORAGE_FAST_SIZE_EXT, CAPS_UINT(shader_pixel_local_storage_fast_size), extra_EXT_shader_pixel_local_storage },
    { GL_SUBGROUP_SIZE_KHR, CONTEXT_INT(Const.ShaderSubgroupSize), extra_KHR_shader_subgroup },
    { GL_SUBGROUP_SUPPORTED_STAGES_KHR, CONTEXT_INT(Const.ShaderSubgroupSupportedStages), extra_KHR_shader_subgroup },
    { GL_SUBGROUP_SUPPORTED_FEATURES_KHR, CONTEXT_INT(Const.ShaderSubgroupSupportedFeatures), extra_KHR_shader_subgroup },
    { GL_SUBGROUP_QUAD_ALL_STAGES_KHR, CONTEXT_BOOL(Const.ShaderSubgroupQuadAllStages), extra_KHR_shader_subgroup },
    ...
    { GL_MAX_TASK_UNIFORM_BLOCKS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_TASK].MaxUniformBlocks), extra_EXT_mesh_shader },
    { GL_MAX_TASK_TEXTURE_IMAGE_UNITS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_TASK].MaxTextureImageUnits), extra_EXT_mesh_shader },
    { GL_MAX_TASK_IMAGE_UNIFORMS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_TASK].MaxImageUniforms), extra_EXT_mesh_shader },
    { GL_MAX_TASK_UNIFORM_COMPONENTS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_TASK].MaxUniformComponents), extra_EXT_mesh_shader },
    { GL_MAX_TASK_ATOMIC_COUNTER_BUFFERS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_TASK].MaxAtomicBuffers), extra_EXT_mesh_shader },
    { GL_MAX_TASK_ATOMIC_COUNTERS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_TASK].MaxAtomicCounters), extra_EXT_mesh_shader },
    { GL_MAX_TASK_SHADER_STORAGE_BLOCKS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_TASK].MaxShaderStorageBlocks), extra_EXT_mesh_shader },
    { GL_MAX_COMBINED_TASK_UNIFORM_COMPONENTS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_TASK].MaxCombinedUniformComponents), extra_EXT_mesh_shader },
    { GL_MAX_MESH_UNIFORM_BLOCKS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_MESH].MaxUniformBlocks), extra_EXT_mesh_shader },
    { GL_MAX_MESH_TEXTURE_IMAGE_UNITS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_MESH].MaxTextureImageUnits), extra_EXT_mesh_shader },
    { GL_MAX_MESH_IMAGE_UNIFORMS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_MESH].MaxImageUniforms), extra_EXT_mesh_shader },
    { GL_MAX_MESH_UNIFORM_COMPONENTS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_MESH].MaxUniformComponents), extra_EXT_mesh_shader },
    { GL_MAX_MESH_ATOMIC_COUNTER_BUFFERS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_MESH].MaxAtomicBuffers), extra_EXT_mesh_shader },
    { GL_MAX_MESH_ATOMIC_COUNTERS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_MESH].MaxAtomicCounters), extra_EXT_mesh_shader },
    { GL_MAX_MESH_SHADER_STORAGE_BLOCKS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_MESH].MaxShaderStorageBlocks), extra_EXT_mesh_shader },
    { GL_MAX_COMBINED_MESH_UNIFORM_COMPONENTS_EXT, CONTEXT_INT(Const.Program[MESA_SHADER_MESH].MaxCombinedUniformComponents), extra_EXT_mesh_shader },
    { GL_MAX_TASK_WORK_GROUP_TOTAL_COUNT_EXT, CAPS_UINT(mesh.max_task_work_group_total_count), extra_EXT_mesh_shader },
    { GL_MAX_MESH_WORK_GROUP_TOTAL_COUNT_EXT, CAPS_UINT(mesh.max_mesh_work_group_total_count), extra_EXT_mesh_shader },
    { GL_MAX_MESH_WORK_GROUP_INVOCATIONS_EXT, CAPS_UINT(mesh.max_mesh_work_group_invocations), extra_EXT_mesh_shader },
    { GL_MAX_TASK_WORK_GROUP_INVOCATIONS_EXT, CAPS_UINT(mesh.max_task_work_group_invocations), extra_EXT_mesh_shader },
    { GL_MAX_TASK_PAYLOAD_SIZE_EXT, CAPS_UINT(mesh.max_task_payload_size), extra_EXT_mesh_shader },
    { GL_MAX_TASK_SHARED_MEMORY_SIZE_EXT, CAPS_UINT(mesh.max_task_shared_memory_size), extra_EXT_mesh_shader },
    { GL_MAX_MESH_SHARED_MEMORY_SIZE_EXT, CAPS_UINT(mesh.max_mesh_shared_memory_size), extra_EXT_mesh_shader },
    { GL_MAX_TASK_PAYLOAD_AND_SHARED_MEMORY_SIZE_EXT, CAPS_UINT(mesh.max_task_payload_and_shared_memory_size), extra_EXT_mesh_shader },
    { GL_MAX_MESH_PAYLOAD_AND_SHARED_MEMORY_SIZE_EXT, CAPS_UINT(mesh.max_mesh_payload_and_shared_memory_size), extra_EXT_mesh_shader },
    { GL_MAX_MESH_OUTPUT_MEMORY_SIZE_EXT, CAPS_UINT(mesh.max_mesh_output_memory_size), extra_EXT_mesh_shader },
    { GL_MAX_MESH_PAYLOAD_AND_OUTPUT_MEMORY_SIZE_EXT, CAPS_UINT(mesh.max_mesh_payload_and_output_memory_size), extra_EXT_mesh_shader },
    { GL_MAX_MESH_OUTPUT_VERTICES_EXT, CAPS_UINT(mesh.max_mesh_output_vertices), extra_EXT_mesh_shader },
    { GL_MAX_MESH_OUTPUT_PRIMITIVES_EXT, CAPS_UINT(mesh.max_mesh_output_primitives), extra_EXT_mesh_shader },
    { GL_MAX_MESH_OUTPUT_COMPONENTS_EXT, CAPS_UINT(mesh.max_mesh_output_components), extra_EXT_mesh_shader },
    { GL_MAX_MESH_OUTPUT_LAYERS_EXT, CAPS_UINT(mesh.max_mesh_output_layers), extra_EXT_mesh_shader },
    { GL_MAX_MESH_MULTIVIEW_VIEW_COUNT_EXT, CAPS_UINT(mesh.max_mesh_multiview_view_count), extra_EXT_mesh_shader },
    { GL_MESH_OUTPUT_PER_VERTEX_GRANULARITY_EXT, CAPS_UINT(mesh.mesh_output_per_vertex_granularity), extra_EXT_mesh_shader },
    { GL_MESH_OUTPUT_PER_PRIMITIVE_GRANULARITY_EXT, CAPS_UINT(mesh.mesh_output_per_primitive_granularity), extra_EXT_mesh_shader },
    { GL_MAX_PREFERRED_TASK_WORK_GROUP_INVOCATIONS_EXT, CAPS_UINT(mesh.max_preferred_task_work_group_invocations), extra_EXT_mesh_shader },
    { GL_MAX_PREFERRED_MESH_WORK_GROUP_INVOCATIONS_EXT, CAPS_UINT(mesh.max_preferred_mesh_work_group_invocations), extra_EXT_mesh_shader },
    { GL_MESH_PREFERS_LOCAL_INVOCATION_VERTEX_OUTPUT_EXT, CAPS_BOOL(mesh.mesh_prefers_local_invocation_vertex_output), extra_EXT_mesh_shader },
    { GL_MESH_PREFERS_LOCAL_INVOCATION_PRIMITIVE_OUTPUT_EXT, CAPS_BOOL(mesh.mesh_prefers_local_invocation_primitive_output), extra_EXT_mesh_shader },
    { GL_MESH_PREFERS_COMPACT_VERTEX_OUTPUT_EXT, CAPS_BOOL(mesh.mesh_prefers_compact_vertex_output), extra_EXT_mesh_shader },
    { GL_MESH_PREFERS_COMPACT_PRIMITIVE_OUTPUT_EXT, CAPS_BOOL(mesh.mesh_prefers_compact_primitive_output), extra_EXT_mesh_shader },
    ...
    { GL_REPRESENTATIVE_FRAGMENT_TEST_NV, CONTEXT_BOOL(RepresentativeFragmentTest), NO_EXTRA },
    ...
    { GL_MAX_TRANSFORM_FEEDBACK_BUFFERS, CONTEXT_INT(Const.MaxTransformFeedbackBuffers), extra_gl40_ARB_transform_feedback3 },
